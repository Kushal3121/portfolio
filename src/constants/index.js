...
const experiences = [
  ...
  // },
  {
    ...
    points: [
      'Designed UX for event portals & newsletters with Adobe XD, improving engagement by 35%.',
      'Created wireframes & interactive prototypes for student registration workflows.',
      'Organized over 10+ cultural and technical events, showcasing strong planning & coordination skills.',
      'Designed 4 newsletters with creative layouts, significantly enhancing participation.',
    ],
  },
];
